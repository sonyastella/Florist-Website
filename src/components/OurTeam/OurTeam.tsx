    ...
    <div className="ourTeam bg-[#efe6dd] text-center py-20">
      ...
      <div className="team-container flex flex-wrap justify-center gap-8">
        {teamMembers.map((member, index) => (
          <div key={index} className="team-member w-32 h-32 text-center p-0 bg-[#efe6dd] rounded-lg shadow-lg">
            <img src={member.picture.large} alt={`${member.name.first} ${member.name.last}`} className="w-32 h-32 object-cover rounded-lg mb-4" />
